package cn.ruanyun.backInterface.generator.vue;

import cn.ruanyun.backInterface.common.exception.RuanyunException;
import cn.ruanyun.backInterface.common.utils.ResultUtil;
import cn.ruanyun.backInterface.common.vo.Result;
import cn.ruanyun.backInterface.generator.bean.Field;
...
@Slf4j
@RestController
@RequestMapping(value = "/ruanyun/generate")
public class RuanyunVueGenerator {
    ...
    public String generate(String template, String vueName, Integer rowNum, List<Field> fields) throws IOException {
        ...
        // 模板路径
        String root = System.getProperty("user.dir")+"/src/main/java/cn/ruanyun/backInterface/generator/vue";
        ...
        // 排序
        fields.sort(Comparator.comparing(Field::getSortOrder));
        // 绑定变量
        ...
        if(rowNum==1){
            ...
            throw new RuanyunException("rowNum仅支持数字1-4");
        }
        // 生成代码
    ...
    public String gengerateEntityData(String path) throws Exception {
        ...
        String end = "\n    ]\n" +
                "}";
        StringBuilder field_all = new StringBuilder();
        ...
        for (int j = 0; j < fields.length; j++) {
            ...
            fieldName_CN = (fieldName_CN == null || fieldName_CN.equals("")) ? fieldName : fieldName_CN;

            String type = "text";
            String searchType = "text";
            // 日期字段特殊处理,其他一律按 字符串界面处理
            if (fieldType.equals("java.lang.Date") || fieldType.equals("java.util.Date") || fieldType.equals("Date")) {
                type = "date";
            ...
            String field_json = "\n        {\n" +
                    ...
                    "        }";
            String splitChar = field_all.toString().equals("") ? "" : ",";
            field_all.append(splitChar).append(field_json);
        }
        return start + field_all + end;
    }
}
