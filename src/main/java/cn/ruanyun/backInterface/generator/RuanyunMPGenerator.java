package cn.ruanyun.backInterface.generator;

import cn.ruanyun.backInterface.generator.bean.Entity;
...
import static cn.ruanyun.backInterface.generator.RuanyunGenerator.*;
 ...
 */
@Slf4j
public class RuanyunMPGenerator {

    /**
     * 实体类名
     * 建议仅需修改
     */
    private static final String className = "DiscountCoupon";

    /**
     * 类说明描述
     * 建议仅需修改
     */
    private static final String description = "优惠券";
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "cn.ruanyun.backInterface.modules.business.discountCoupon.pojo";

    /**
     * dao对应包
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "cn.ruanyun.backInterface.modules.business.discountCoupon.mapper";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "cn.ruanyun.backInterface.modules.business.discountCoupon.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "cn.ruanyun.backInterface.modules.business.discountCoupon.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "cn.ruanyun.backInterface.modules.business.discountCoupon.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
        String root = System.getProperty("user.dir")+"\\src\\main\\java\\cn\\ruanyun\\backInterface\\generator\\template";
