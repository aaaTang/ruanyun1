...
import cn.ruanyun.backInterface.config.jiGuang.JiGuangConfig;
import cn.ruanyun.backInterface.modules.jpush.bean.PushBean;
import cn.ruanyun.backInterface.modules.jpush.service.MyJiGuangPushService;
...
public class MyJiGuangPushServiceImpl implements MyJiGuangPushService {
    ...
    public boolean sendPush(PushPayload pushPayload){
        ...
        try{
            result = jiGuangConfig.getJPushClient().sendPush(pushPayload);
