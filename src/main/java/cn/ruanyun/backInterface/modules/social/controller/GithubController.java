...
import cn.ruanyun.backInterface.modules.social.vo.GithubUserInfo;
...
@RequestMapping("/ruanyun/social/github")
@Controller
public class GithubController {

    @Value("${ruanyun.social.github.clientId}")
    private String clientId;

    @Value("${ruanyun.social.github.clientSecret}")
    private String clientSecret;

    @Value("${ruanyun.social.github.callbackUrl}")
