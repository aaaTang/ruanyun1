...
import cn.ruanyun.backInterface.modules.social.vo.QQUserInfo;
...
@RequestMapping("/ruanyun/social/qq")
@Controller
public class QQController {

    @Value("${ruanyun.social.qq.appId}")
    private String appId;

    @Value("${ruanyun.social.qq.appKey}")
    private String appKey;

    @Value("${ruanyun.social.qq.callbackUrl}")
