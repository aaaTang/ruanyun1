...
import cn.ruanyun.backInterface.modules.social.vo.AccessToken;
import cn.ruanyun.backInterface.modules.social.vo.WeiboUserInfo;
...
@RequestMapping("/ruanyun/social/weibo")
@Controller
public class WeiboController {

    @Value("${ruanyun.social.weibo.appKey}")
    private String appKey;

    @Value("${ruanyun.social.weibo.appSecret}")
    private String appSecret;

    @Value("${ruanyun.social.weibo.callbackUrl}")
    private String callbackUrl;

    @Value("${ruanyun.social.callbackFeUrl}")
    private String callbackFeUrl;

    @Value("${ruanyun.social.callbackFeRelateUrl}")
