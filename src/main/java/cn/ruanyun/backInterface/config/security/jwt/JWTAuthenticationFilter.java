...
public class JWTAuthenticationFilter extends BasicAuthenticationFilter {
    ...
    public JWTAuthenticationFilter(AuthenticationManager authenticationManager, RuanyunTokenProperties tokenProperties, StringRedisTemplate redisTemplate, SecurityUtil securityUtil) {
