package cn.ruanyun.backInterface.config.interceptor;


import cn.hutool.core.util.StrUtil;
import cn.ruanyun.backInterface.common.annotation.RateLimiter;
...
public class LimitRaterInterceptor extends HandlerInterceptorAdapter {
    ...
    @Autowired
    private RuanyunLimitProperties limitProperties;

    @Autowired
    private RuanyunIpLimitProperties ipLimitProperties;
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        if(ipLimitProperties.getEnable()) {
            ...
            if (StrUtil.isBlank(token1)) {
                throw new RuanyunException("你手速怎么这么快，请点慢一点");
            }
        }
        ...
        if(limitProperties.getEnable()){
            ...
            if (StrUtil.isBlank(token2)) {
                throw new RuanyunException("当前访问总人数太多啦，请稍后再试");
            }
        }
        ...
        try {
            ...
            if (rateLimiter != null) {
                ...
                if (StrUtil.isBlank(token3)) {
                    throw new RuanyunException("当前访问人数太多啦，请稍后再试");
                }
            }
