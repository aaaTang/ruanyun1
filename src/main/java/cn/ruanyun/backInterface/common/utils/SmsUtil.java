...
import cn.ruanyun.backInterface.modules.base.vo.SmsSetting;
...
public class SmsUtil {
    ...
    public SmsSetting getSmsSetting(){
        ...
        if(StrUtil.isBlank(setting.getValue())){
            throw new RuanyunException("您还未配置阿里云短信");
        }
     ...
     * @throws ClientException
     */
    public void sendActMessage(String mobile, String content) throws ClientException {
